                    ...
                    {blog.data.map((post) => {
                        ...
                        const jsonLd = {
                            ...
                            publisher: {
                                ...
                                logo: {
                                    '@type': 'ImageObject',
                                    url: `${baseUrl}/images/shared/Kasun_Sameera.png`
                                }
                            },
                            mainEntityOfPage: {
                                '@type': 'WebPage',
                        ...
                        if (post.postPrimary?.categories?.[0]) {
                            breadcrumbItems.push({
                                ...
                                "item": {
                                    "@type": "WebPage",
                                    "@id": `${baseUrl}/category/${post.postPrimary.categories[0].toLowerCase().trim().replace(/[^\w\s-]/g, '').replace(/\s+/g, '-')}`
                                }
                            });
                        }
                                ...
                                {blog.data.map((post) => (
                                    <div key={post.id} className="bg-white rounded-3xl shadow-xl p-8 lg:p-12 relative overflow-hidden">
                                        ...
                                        <div className="relative">
                                            ...
                                            <ShareButtons
                                                title={post.title}
                                                url={`${process.env.NEXT_PUBLIC_BASE_URL || 'https://www.kasunsameera.com'}/${post.postSlug}`}
